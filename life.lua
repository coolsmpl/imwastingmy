...
task.spawn(function() while true do wait(0.45) Chat("lol | code made by c2vp on ds") end end)


spawn(function() while true do wait(0.5) numb = numb + 1 if numb == 212 then game.Players.LocalPlayer:Kick("serverhopping") wait(0.5) pcall(hop) end end end)
